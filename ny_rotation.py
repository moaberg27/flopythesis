...
# ============================================================
# Test mode: isotropic vs anisotropic(random)
# ============================================================
...
# Tredje och fjärde steg: gemensam loop från normalläge.
tilt_x_angles_step3 = [15]
...
sequence_specs = [
    ("step3", 15, z_angles_step3),
    ("step4", 30, z_angles_step4),
    ("step4", 45, z_angles_step4),
    ("step4", 60, z_angles_step4),
    ("step4", 75, z_angles_step4),
]

for step_name, tilt_x_deg, z_values in sequence_specs:
    add_yz_then_xy_sequence(step_name, tilt_x_deg, z_values)
